...
public class ProcessingUserRequest {
    ...
    public static int result(String userCommand, HashSet<Flat> flats, LocalDateTime today, DBHandler db) {
        ...
        if (parts[0].equalsIgnoreCase("remove_by_id")) {
            try {
                ...
                if (id<=0) {
                    ...
                    Remove_By_Id rm = new Remove_By_Id(flats, id, db);
                    rm.execute();
        ...
        if (parts[0].equalsIgnoreCase("update")) {
            try {
                ...
                if (id<=0) {
                    ...
                    Update update = new Update(flats, id, db);
                    update.check();
