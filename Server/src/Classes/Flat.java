...
public class Flat implements Comparable<Flat> {
    ...
    public Flat(int id, String name, Coordinates coordinates, LocalDate creationDate, Float area, int numberOfRooms,
                boolean new1, View view, Transport transport, House house, Integer userId) {
        this.id = id;
        this.name = name;
