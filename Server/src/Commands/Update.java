...
public class Update implements Serializable {
    ...
    public Update (HashSet<Flat> flats, Integer elementId, DBHandler db) {
        this.flats = flats;
        this.elementId = elementId;
        this.info = null;
        this.db = db;
    ...
    public void check() {
        ...
        } else if (userId.intValue()!=flat.getUserId().intValue()) {
