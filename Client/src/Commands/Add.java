...
public class Add implements Serializable {
    ...
    public Add (HashSet<Flat> flats, DBHandler db) {
        this.flats = flats;
        this.info = null;
        this.db = db;
    }
        ...
        if (transport == null) {
            if (year == null) {
                command = "INSERT INTO flats (flat_name, x, y, creation_date_year, creation_date_month, creation_date_day, " +
                        ...
                        "values ('"+name+"', "+x.toString()+", "+y.toString()+", "+randomDate.getYear()+", "+
                        randomDate.getMonthValue()+", "+randomDate.getDayOfMonth()+
                        ", "+area.toString()+", "+numberOfRooms+", "+new1+", '"+view.toString()+"', '"+houseName+"', "+
                        numberOfFlatsOnFloor+", "+numberOfLifts+", "+userId+")";
            } else {
                command = "INSERT INTO flats (flat_name, x, y, creation_date_year, creation_date_month, creation_date_day, " +
                        ...
                        "values ('"+name+"', "+x.toString()+", "+y.toString()+", "+randomDate.getYear()+", "+
                        randomDate.getMonthValue()+", "+randomDate.getDayOfMonth()+
                        ", "+area.toString()+", "+numberOfRooms+", "+new1+", '"+view.toString()+"', '"+
                        houseName+"', "+
                        year.toString()+", "+numberOfFlatsOnFloor+", "+numberOfLifts+", "+userId+")";
            }
        } else {
            if (year == null) {
                command = "INSERT INTO flats (flat_name, x, y, creation_date_year, creation_date_month, creation_date_day, " +
                        ...
                        "values ('"+name+"', "+x.toString()+", "+y.toString()+", "+randomDate.getYear()+", "+
                        randomDate.getMonthValue()+", "+randomDate.getDayOfMonth()+
                        ", "+area.toString()+", "+numberOfRooms+", "+new1+", '"+view.toString()+"', '"+transport+
                        "', '"+houseName+"', "+
                        numberOfFlatsOnFloor+", "+numberOfLifts+", "+userId+")";
            } else {
                command = "INSERT INTO flats (flat_name, x, y, creation_date_year, creation_date_month, creation_date_day, " +
