                        ...
                        if (houseYear != null) {
                            if (transport != null) {
                                if (id != null && name != null && x != null && y != null && year != null && month != null && day != null && area != -1.0f &&
                                    ...
                                    flats.add(new Flat(id, name, new Coordinates(x, y), LocalDate.of(year, month, day), area, numberOfRooms, new1, View.valueOf(view), Transport.valueOf(transport), new House(houseName, houseYear, numberOfFlatsOnFloor, numberOfLifts),1));
                                }
                            } else {
                                if (id != null && name != null && x != null && y != null && year != null && month != null && day != null && area != -1.0f &&
                                        numberOfRooms != -1 && view != null && transport != " " && houseName != null && houseYear != -1 &&
                                        numberOfFlatsOnFloor != -1 && numberOfLifts != -1) {
                                    flats.add(new Flat(id, name, new Coordinates(x, y), LocalDate.of(year, month, day), area, numberOfRooms, new1, View.valueOf(view), null, new House(houseName, houseYear, numberOfFlatsOnFloor, numberOfLifts),1));
                                }
                            }
                        } else {
                            if (transport != null) {
